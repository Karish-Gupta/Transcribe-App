...
import com.google.aiedge.examples.imageclassification.CloudBasedInference.PredictionResponse
...
class ImageClassificationHelper(
    ...
    class Options(
        /** The boolean conatins whether the inference is on-device (True) or cloud (False)*/
        var inferenceDevice: InferenceDevice = DEFAULT_INFERENCE_DEVICE,
    ...
    companion object {
        ...
        val DEFAULT_INFERENCE_DEVICE = InferenceDevice.OnDevice
